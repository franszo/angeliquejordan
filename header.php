		...
		<div class="inner container">
			<h1 class="logo-container">
				<a class="logo icon" href="<?php echo home_url( '/' ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
					<svg version="1.1" id="ajlogo" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
						 width="268.373px" height="459.004px" viewBox="0 0 268.373 459.004" enable-background="new 0 0 268.373 459.004"
						 xml:space="preserve">
					<path class="path" fill="none" stroke="#010101" stroke-miterlimit="10" d="M152.646,423.566l6.773-7.742c5.162-4.839,7.743-2.58,10.969,0.97
					...
					<path class="path" fill="none" stroke="#010101" stroke-miterlimit="10" d="M152.776,215.102c0,7.891-6.396,14.288-14.289,14.288
						c-7.89,0-14.287-6.397-14.287-14.288c0-7.892,6.397-14.288,14.287-14.288C146.38,200.813,152.776,207.21,152.776,215.102"/>
					<path class="path" fill="none" stroke="#010101" stroke-miterlimit="10" d="M119.238,2.5h-12.519c-0.543,0-1.063,0.06-1.381,0.104
